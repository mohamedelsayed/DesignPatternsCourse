...
{
    public function testCanGetTotalPriceOfPackageTreee()
    {
    ...
    public function testCanGetTotalPriceOfPackageTreeeWithAddActions()
    {
        $item1 = new SimpleBox(300);
        $item2 = new SimpleBox(200);
        $package = new BigBox([$item2, $item1]);
    ...
    public function testCanGetTotalPriceOfPackageTreeeWithRemoveActions()
    {
        $item1 = new SimpleBox(300);
        $item2 = new SimpleBox(200);
